...
def get_data():
    ...
    #now do daily queries to get the page views
    ...
    dimensions = ['ga:pagePath', 'ga:country', 'ga:deviceCategory']
    ...
    for i in range(len(start_dates)):
        ...
        insert_data(temp_df, 'Spectator Analytics.db', 'join page country device')
    ...
    #insert_data(df_subscriber_data, 'Spectator Analytics.db', 'subscriber detail')
    #insert_data(df_agg_pivot, 'Spectator Analytics.db', 'subscriber breakdown')
    #
